      ...
      <div className="auth-right flex items-center justify-center">
        <div className="auth-card max-w-lg w-full p-8">
          <div className="mb-6">
            ...
            <h2 className="text-[24px] font-semibold leading-[132%] text-[#0E112F] max-w-full md:w-[400px] mt-2">Criar conta</h2>
            <p className="text-[#464972] font-medium text-[14px] leading-[140%] max-w-full md:w-[400px]">Preencha os dados abaixo para criar sua conta.</p>
              ...
              <form onSubmit={submit} className="space-y-[24px]">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-1 md:gap-2 mt-4">
                  ...
                  <a href="/" className="text-[#181C4F] font-semibold text-[14px] leading-[24px] hover:opacity-80 md:mt-5">
                    Voltar ao login
                  </a>
                </div>
              </form>
