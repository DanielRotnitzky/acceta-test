...
// Left-side will show only the uploaded SVG (public/images/Login.svg)
  ...
  return (
    <div className="auth-layout">
      <div className="auth-left flex items-center justify-center">
        <img src="/images/Login.svg" alt="Ilustração login" className="max-w-full h-auto" />
      </div>

          <div
            className={isMobile ? "" : "auth-right"}
            style={isMobile ? { width: '100%', maxWidth: 360, margin: '24px auto 0 auto' } : undefined}
          >
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="flex justify-center md:justify-end mb-4">
              <button 
                type="button"
                onClick={handleReset}
                className="text-black font-medium font-semibold text-[14px] leading-[140%] hover:opacity-80 transition-opacity w-full md:w-[400px] text-center md:text-right"
              >
                Esqueci minha senha
              </button>
            </div>
            ...
            <div className="mt-4 flex flex-col md:flex-row items-center justify-center gap-1 md:gap-0.5">
              ...
              <a href="/register" className="text-[#181C4F] font-semibold text-[14px] leading-[24px] hover:opacity-80 md:w-[86px] md:mt-5">
                Inscrever-se
              </a>
            </div>
          </form>
